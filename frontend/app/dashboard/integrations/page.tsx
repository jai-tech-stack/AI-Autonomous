...
import { LogOut, ArrowLeft, Link } from 'lucide-react';
  ...
  return (
    <AnimatedContainer>
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 flex flex-col">
            ...
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center space-x-4">
                ...
                <nav className="hidden md:flex space-x-6">
                  ...
                  <a href="/dashboard/integrations" className="text-white hover:text-purple-200">Integrations</a>
                </nav>
              </div>
              <div className="flex items-center space-x-4">
        ...
        {/* Integration Ecosystem Interface */}
