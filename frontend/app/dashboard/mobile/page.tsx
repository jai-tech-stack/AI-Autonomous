...
import MobileCrossPlatform from '@/components/MobileCrossPlatform';
  ...
  return (
    <AnimatedContainer>
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 flex flex-col">
            ...
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <h1 className="text-2xl font-bold text-white">Mobile & Cross-Platform</h1>
                </div>
                <nav className="hidden md:flex space-x-6">
                  ...
                  <a href="/dashboard/immersive" className="text-purple-200 hover:text-white">Immersive</a>
                  <a href="/dashboard/mobile" className="text-white hover:text-purple-200">Mobile</a>
                </nav>
              </div>
              <div className="flex items-center space-x-4">
        ...
        {/* Mobile Cross-Platform Interface */}
