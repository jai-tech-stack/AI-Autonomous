...
import ImmersiveARVR from '@/components/ImmersiveARVR';
            ...
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <h1 className="text-2xl font-bold text-white">Immersive Experience</h1>
                </div>
                <nav className="hidden md:flex space-x-6">
                  ...
                  <a href="/dashboard/immersive" className="text-white hover:text-purple-200">Immersive</a>
                </nav>
              </div>
              <div className="flex items-center space-x-4">
